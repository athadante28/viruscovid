...
<div class="site-mobile-menu site-navbar-target">
    ...
    <div class="hero-v1">
        ...
        <br><br>";
        echo"<a href='index.php' class='btn btn-success'><span class='iconify' data-icon='clarity:success-line' data-inline='false'></span> Terima kasih Telah Menjawab Soal Silah Kembali Kehalaman </a>";
        echo"</div>";
          //masukan hasil kedb
